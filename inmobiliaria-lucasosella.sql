...
(2, 'calle falsa', 'COMERCIAL', 1, '-77.000, 50.600', 15000, 'DISPONIBLE', 2, 1),
(3, 'Calle de pepito', 'RESIDENCIAL', 4, '-50.700, -32.500', 20000, 'DISPONIBLE', 10, 2);
...
(1, 2, 123, '2025-09-23', 'Pago de alquiler', 15000, 'ACTIVO', 3, 3);
...
(10, 43282118, 'nuñes', 'pepito', '02222222222', 'email@gmail.com', '20 de julio');
...
(3, 'Lucas', 'Osella', 'lo@gmail.com', 'lu123', 1, 1, '2025-09-05', ''),
(10, 'Lucas ', 'Osella', 'lucasosella01@gmail.com', 'AQAAAAIAAYagAAAAEKYRYcNAJzqVx0pxFTz3yfs2hNueaqkoqkXNqccA9PYVIVdJ0xUSa5RZsNRoEwSLDg==', 1, 1, '0000-00-00', ''),
(12, 'Juan', 'Diego Arce', 'jd@gmail.com', 'AQAAAAIAAYagAAAAEN/T5NheBmzM1B/kPAVclPYtOcwmZaqUds9/hc+NSyO+z+XfdYsh+EHo3KbBplPA3A==', 2, 1, '0000-00-00', '');
